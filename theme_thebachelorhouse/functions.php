...
function twentythirteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Privacy Policy Content', 'twentythirteen' ),
		'id'            => 'privacy-policy-widget',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Terms Content', 'twentythirteen' ),
		'id'            => 'terms-widget',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'Footer Banner', 'twentythirteen' ),
		'id'            => 'footer-banner',
		'description'   => __( 'Start your journey banner in the footer', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
add_action( 'customize_preview_init', 'twentythirteen_customize_preview_js' );
  ...
  //Add shortcodes in Text Widgets 
	...
	//remove_filter('the_content', 'wpautop');// remove empty <p> tag
...
add_action('init', 'setup_types');
	...
	//creating custom post type for blog
	function my_custom_post_blog() {
	register_post_type( 'Blog', array( 'public' => true, 'label' => 'Blog' ) );
}
...
function for_gallary_form_shortcode(){ 
      return '<h2>Book a Photoshoot</h2>
	  <h3>Contact information*</h3>
	  <p>please enter your name and email address</p>
	  <form class="diolog-inner-form" action="#" id="abc" name="abc">
<div class="diolog-inner-two"><input type="text" placeholder="First Name">
<input type="email" placeholder="Email">
</div>
<div class="diolog-inner-two"><select>
  ...
  <option value="70 or above">70 or above</option>
</select>
<input type="text" name="date" value="">
</div>
<div class="diolog-inner-two"><input type="text" placeholder="Telephone">
<input type="file" name="fileToUpload" id="fileToUpload">
</div>
<div class="diolog-inner-two"><input type="button" value="PROCEED TO PAYPAL"></div>
</form>';
	}
add_shortcode( 'put_gallary_form_here', 'for_gallary_form_shortcode' );
	?>
